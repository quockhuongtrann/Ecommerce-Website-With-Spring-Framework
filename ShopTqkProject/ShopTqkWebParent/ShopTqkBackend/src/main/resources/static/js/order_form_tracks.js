		...
		<div class="row border rounded p-1" id="${rowId}">
				...
				<div class="col-10">
					<div class="form-group row">
						...
						<div class="col">
							<input type="datetime-local" name="trackDate" value="${currentDateTime}"
								class="form-control" required style="max-width: 300px" />
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col">
							<select name="trackStatus" rowNumber="${nextCount}" class="form-control dropDownStatus" required style="max-width: 150px;"
	`;
