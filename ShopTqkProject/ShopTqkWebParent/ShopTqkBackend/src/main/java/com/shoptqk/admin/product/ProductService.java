...
import com.shoptqk.admin.review.ReviewRepository;
...
//		
//		List<Review> listReviews = reviewRepository.findByProductId(updatedProduct.getId());
//		if (listReviews.size() > 0) {
//			productRepository.updateReviewCountAndAverageRating(updatedProduct.getId());
//		} else {
//			updatedProduct.setAverageRating(0);
